...
const Questions = () => {
    return (
        <section className='bg-black position-relative' id='whitepaper'>
            ...
            <div className=" position-absolute questions2"><img src={Questions2} alt="question" /></div>
            <img src={Bottomunion} alt="bottomunion" className='w-100 z-1 position-relative' />
            <Container>
                <h2 className='font-manrope fw-bold fs-48 lh-57 text-center mb-0 white-light pt-lg-97 pt-sm-80 pt-60 text-center z-1 position-relative'>Frequently Asked <span className="color-yellow">Questions</span></h2>
